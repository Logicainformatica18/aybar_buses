                        ...
                        <div class="sidebarmenu">
                            ...
                            <nav class="sidebar-nav" id="menu-right-mini-1" data-simplebar>
                                <ul class="sidebar-menu" id="sidebarnav">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="{{url('admin/buses')}}" aria-expanded="false">
                                            <iconify-icon icon="solar:atom-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Buses</span>
                                        </a>
                                    </li>
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="{{url('admin/programacion')}}" aria-expanded="false">
                                            <iconify-icon icon="solar:atom-line-duotone"></iconify-icon>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="{{url('admin/reserva')}}" aria-expanded="false">
                                            <iconify-icon icon="solar:atom-line-duotone"></iconify-icon>
                                            <span class="hide-menu">Reserva</span>
                                        </a>
                                    </li>
                                    {{-- <li class="nav-small-cap">
